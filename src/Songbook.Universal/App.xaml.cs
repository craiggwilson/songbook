...
namespace Songbook.Universal
{
    ...
    sealed partial class App : Application
    {
        ...
        private static void SetupTitleBar()
        {
            ...
            titleBar.ForegroundColor = (Color)Application.Current.Resources["SystemChromeWhiteColor"];
            ...
            titleBar.ButtonHoverBackgroundColor = ChangeColor(accentColor, 1.3);
            titleBar.ButtonPressedBackgroundColor = ChangeColor(accentColor, 1.4);
        }

        private static Color ChangeColor(Color color, double percentage)
        {
            return Color.FromArgb(
                    color.A,
                    (byte)(color.R * percentage),
                    (byte)(color.G * percentage),
                    (byte)(color.B * percentage));
        }
    }
}
